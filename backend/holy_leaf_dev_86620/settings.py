"""
Django settings for holy_leaf_dev_86620 project.
...
ROOT_URLCONF = 'holy_leaf_dev_86620.urls'
...
WSGI_APPLICATION = 'holy_leaf_dev_86620.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "holy_leaf_dev_86620 API",
    "DESCRIPTION": "API documentation for holy_leaf_dev_86620 App",
    "VERSION": "v1",
}
